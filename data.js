const eventData = [
    ...
    },
    {
        ...
        subtitle: "(Short Film)",
        icon: "fa-video",
        description: "Short film competition. Themes: 'Campus Diaries – Youth & College Life', 'Tradition vs Tomorrow – Culture & Change', 'Village Dreams, City Rush – Village Life vs City Life', 'When Skills Go Silent – Technology & Unemployment', 'Chalk to Change – Power of Education'. Participants are allowed to use AI tools to enhance their video.",
        teamSize: "Max 5 Members",
        rules: [
            "Duration: 5 minutes only.",
            "Must follow one of the themes.",
            "Themes: Campus Diaries, Tradition vs Tomorrow, Village Dreams City Rush, When Skills Go Silent, Chalk to Change.",
            "Participants are allowed to use AI tools to enhance their video.",
